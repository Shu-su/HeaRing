...
## <목차>
### 1.[개요](#1-개요) <br>
### 2.[개발 전 원격제어 환경 구성 ](#2-개발-전-원격제어-환경-구성-방법)<br>
### 3.[개발시 사용한 부품과 적용](#3-개발시-사용한-부품과-적용-방법) <br>
...
본 프로젝트는 라즈베리파이를 기반으로 치매 환자의 안전을 보장하고 위치를 추적하는 소형 단말기를 설계한다
...
<br><br>
### 2) 앞으로의 추가적인 확장성과 한계점보완 방법 계획: <br> 
