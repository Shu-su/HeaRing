...
치매 환자의 주요 증상인 **‘배회’는 사고 위험을 높이며, 농촌 지역과 같은 열악한 환경에서는 신속한 구조가 어려운 상황**입니다. 이러한 배회의 대응책 중 하나인 **치매 환자 실종 경보 문자**는 전체 경보 중 높은 비중을 차지하지만, 시민 제보에 의한 발견율이 27%에 그쳐 **경보 피로감과 행정 의존도를 줄일 새로운 해결책**이 요구됩니다.<br>

이러한 문제를 해결하기 위해 위험 상황을 조기에 감지하고 효과적으로 대응할 수 있는 관리 시스템 <헤아Ring>을 고안하게 되었습니다.
<br><br>
...
<img width='100%' src='https://github.com/user-attachments/assets/ed93d71e-0657-4fd0-af1b-0ab24d1ae556'>
