...
### 3️⃣ 위험 발화 데이터 증강
> 첨부된 코드  **'2_데이터 증강(KorEDA).ipynb'로 진행**하였습니다. <br>
...
> 이후 **KorEDA**를 이용하여 2차 증강을 진행해주었습니다. (첨부된 코드
...
> 첨부된 코드 **'3_위험상황판단AI_KoBERT.ipynb'로 진행**하였습니다. <br>
...
> 단일 모델 기반으로는 높은 성능을 보엿지만, 새로운 위험 발화 단어나 예외적인 발화가 입력될 경우 모델 예측이 부정확해지는 한계가 드러나기도 했습니다. <br>
...
> 다음 프로젝트를 진행할 땐 이번 프로젝트에서 얻은 경험을 바탕으로 초기 설계를 보다 꼼꼼히 진행하고, 일정 관리와 기능 개발 속도를 개선하여 더 실용적이고 확장성 있는 시스템을 개발해보고 싶습니다. <br>
